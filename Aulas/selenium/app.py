...
# 3. baixar o driver.
"""
Este é um código simples de automatização que irá simular um usuário
acessando o GitHub.
"""
...
class ChromeAuto:
    def __init__(self):
        self.driver_path = 'chromedriver'  # O arquivo.exe
...
#        assert usuario in profile_link_html
    ...
    def faz_login(self):
        try:
            ...
            input_login.send_keys('usuário')  # Colocar o seu usuário
            input_password.send_keys('senha')  # Colocar a sua senha
            sleep(3)
            btn_login.click()
        except Exception as e:
...
if __name__ == '__main__':
    ...
    chrome.clica_perfil()
    #chrome.verifica_usuario('nome_do_usuário')
